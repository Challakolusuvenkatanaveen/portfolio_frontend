...
const BACKEND_URL = 'https://portfolio-challakolusuvenkatanaveen-lw95.onrender.com';
...
const ChatBot = () => {
  ...
  useEffect(() => {
    if (!messages.length && isOpen) {
      setMessages([
        { id: 1, text: "Hi! I'm Venkata naveen's portfolio assistant. I can answer questions about skills, projects, experience, education, certificates, and more!", sender: 'bot', timestamp: Date.now() },
      ]);
    }
  }, [isOpen]);
